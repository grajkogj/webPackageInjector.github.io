...
function inject() {
        let feedback = document.getElementById("injector-feedback");
        ...
        if(s.checked == true && h.checked == false) {
                ...
                if(document.getElementById("injected-script")) {
                        ...
                        feedback.innerHTML = "Injection encountered an unexpected error. Failed to inject."
                };
        } else if(h.checked == true && s.checked == false) {
        ...
        } else if(h.checked == false && s.checked == false) {
